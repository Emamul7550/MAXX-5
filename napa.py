...
---------------------------------------------------
𝗧𝗢𝗢𝗟𝗦 𝗨𝗣𝗗𝗔𝗧𝗘 𝗙𝗜𝗥𝗦𝗧 𝗦𝗘𝗡𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 𝗥𝗘𝗤𝗨𝗘𝗦𝗧
---------------------------------------------------
[+] 𝗔𝗨𝗧𝗛𝗢𝗥  : EMAMUL HOSSAIN SHUVO
[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞: EMAMUL HOSSAIN SHUVO
[+] 𝗚𝗜𝗧𝗛𝗨𝗕  :ERROR
[+] 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 :1.9
----------------------------------------------------
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/Emamul.Shuvo.Normal.User.7k.1")
		exit()
	else:
		os.system("https://www.facebook.com/Emamul.Shuvo.Normal.User.7k.1")
		exit()
